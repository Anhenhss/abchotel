      ...
      <Modal title={<span style={{color: COLORS.DARKEST, fontSize: 18}}>Chỉnh sửa Hạng phòng</span>} open={isEditModalOpen} onCancel={() => setIsEditModalOpen(false)} footer={null} width={700}>
        <Form form={editForm} layout="vertical" onFinish={handleSaveEdit}>
          <Row gutter={16}>
            ...
            <Col xs={12} md={6}><Form.Item name="bedType" label="Giường"><Select size="large" options={[{value: '1 Giường Đơn'}, {value: '2 Giường Đơn'}, {value: '1 Giường Đôi'}, {value: '2 Giường Đôi'}]} /></Form.Item></Col>
          </Row>
